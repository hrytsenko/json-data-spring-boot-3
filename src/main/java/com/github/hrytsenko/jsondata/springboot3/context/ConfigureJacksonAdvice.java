...
@Configuration
class ConfigureJacksonAdvice {

  @Bean
  Jackson2ObjectMapperBuilderCustomizer jsonEntityJacksonCustomizer() {
  ...
  @AllArgsConstructor
  static final class JsonEntityDeserializer extends JsonDeserializer<JsonEntity<?>> {
  ...
  static final class JsonEntityDeserializerModifier extends BeanDeserializerModifier {

    @Override
    public JsonDeserializer<?> modifyDeserializer(DeserializationConfig config, BeanDescription bean,
  ...
  static final class JsonEntitySerializer extends JsonSerializer<JsonEntity<?>> {
  ...
  static final class JsonEntitySerializerModifier extends BeanSerializerModifier {
